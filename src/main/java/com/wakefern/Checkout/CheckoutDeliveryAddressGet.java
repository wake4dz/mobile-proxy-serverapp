...
public class CheckoutDeliveryAddressGet extends BaseService {
    @GET
    ...
    public Response getInfoResponse(@PathParam("userId") String userId, @PathParam("storeId") String storeId,
        ...
        map.put(ApplicationConstants.Requests.Header.contentAccept, "application/vnd.mywebgrocer.delivery-info+json");
    ...
    public CheckoutDeliveryAddressGet(){
