...
public class FulfillmentDeliveryDateTimes extends BaseService {
    ...
    public Response getInfoResponse(@PathParam("storeId") String storeId, @PathParam("zipCode") String zipCode,
        ...
        prepareResponse(storeId, zipCode, year, month, day, authToken);
    ...
    public String getInfo(String storeId, String zipCode, String year, String month, String day, String authToken) throws Exception, IOException {
        prepareResponse(storeId, zipCode, year, month, day, authToken);
    ...
    private void prepareResponse(String storeId, String zipCode, String year, String month, String day, String authToken){
