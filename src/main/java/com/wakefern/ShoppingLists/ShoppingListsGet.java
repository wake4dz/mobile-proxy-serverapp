...
public class ShoppingListsGet extends BaseService {
    ...
    public Response getInfoResponse(@PathParam("chainId") String chainId, @PathParam("userId") String userId,
        ...
        prepareResponse(chainId, userId, authToken);
    ...
    public String getInfo(String chainId, String userId, String authToken) throws Exception, IOException {
        prepareResponse(chainId, userId, authToken);
    ...
    private void prepareResponse(String chainId, String userId, String authToken){
