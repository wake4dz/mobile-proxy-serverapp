...
public class CreateItem extends BaseService {
	
	private final static Logger logger = LogManager.getLogger(CreateItem.class);
    ...
    public Response getResponse(    
        ...
        try {		
			this.requestHeader = new MWGHeader(MWGApplicationConstants.Headers.json, MWGApplicationConstants.Headers.Cart.item, sessionToken);
            ...
            String jsonResponse = this.mwgRequest(BaseService.ReqType.POST, jsonData, MI9TimeoutRegistry.CART_CREATE_ITEM, MI9TimeoutRegistry.getTimeout(MI9TimeoutRegistry.CART_CREATE_ITEM));
        	...
        	LogUtil.addErrorMaps(e, MwgErrorType.CART_CREATE_ITEM);
