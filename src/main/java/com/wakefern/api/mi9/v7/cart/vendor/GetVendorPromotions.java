...
public class GetVendorPromotions extends BaseService {
	...
	private final static Logger logger = LogManager.getLogger(GetVendorPromotions.class);
    ...
    public Response getResponse(
		...
		try {
            ...
            String jsonResponse = this.mwgRequest(BaseService.ReqType.GET, null, MI9TimeoutRegistry.CART_GET_VENDOR_PROMOTIONS, MI9TimeoutRegistry.getTimeout(MI9TimeoutRegistry.CART_GET_VENDOR_PROMOTIONS));
