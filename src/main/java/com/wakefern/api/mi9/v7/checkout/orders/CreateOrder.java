...
import com.wakefern.api.wakefern.apim.smsenrollment.SmsEnrollment;
	...
	private Response placeOrder(String mwgStoreID, String userID, String accept, String contentType,
		...
		try {
			...
			String jsonResponse = this.mwgRequest(BaseService.ReqType.POST, null,
					MI9TimeoutRegistry.CHECKOUT_CREATE_ORDER,
					MI9TimeoutRegistry.getTimeout(MI9TimeoutRegistry.CHECKOUT_CREATE_ORDER));
