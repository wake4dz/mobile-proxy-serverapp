...
public class GetOrderResults extends BaseService {
	...
	private final static Logger logger = LogManager.getLogger(GetOrderResults.class);
    ...
    public Response getResponse(
        ...
        try {	
            ...
            String jsonResponse = this.mwgRequest(BaseService.ReqType.GET, null, "package com.wakefern.checkout.orders.GetOrderResults");
        	...
        	LogUtil.addErrorMaps(e, MwgErrorType.ORDERS_GET_ORDER_RESULTS);
