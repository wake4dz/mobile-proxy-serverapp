...
public class GetBillingAddr extends BaseService {
	
	private final static Logger logger = LogManager.getLogger(GetBillingAddr.class);
    ...
    public Response getResponse(
		...
		try {
			this.requestHeader = new MWGHeader(MWGApplicationConstants.Headers.Checkout.addressV2, MWGApplicationConstants.Headers.json, sessionToken);
            ...
            String jsonResponse = this.mwgRequest(BaseService.ReqType.GET, null, "com.wakefern.checkout.users.GetBillingAddr");
        	...
        	LogUtil.addErrorMaps(e, MwgErrorType.USERS_GET_BILLING_ADDR);
