...
public class GetCheckoutState extends BaseService {
	...
	private final static Logger logger = LogManager.getLogger(GetCheckoutState.class);
    ...
    public Response getResponse(
		...
		try {
            ...
            String jsonResponse = this.mwgRequest(BaseService.ReqType.GET, null, MI9TimeoutRegistry.CHECKOUT_GET_STATE, MI9TimeoutRegistry.getTimeout(MI9TimeoutRegistry.CHECKOUT_GET_STATE));
