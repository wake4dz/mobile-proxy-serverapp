...
public class GetDeliveryAddr extends BaseService {
	
	private final static Logger logger = LogManager.getLogger(GetDeliveryAddr.class);
    ...
    public Response getResponse(
        ...
        try {	
            ...
            String jsonResponse = this.mwgRequest(BaseService.ReqType.GET, null, "com.wakefern.checkout.users.GetDeliveryAddr");
