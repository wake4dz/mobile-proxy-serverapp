...
public class GetFulfillmentOpts extends BaseService {
	
	private final static Logger logger = LogManager.getLogger(GetFulfillmentOpts.class);
	 ...
	 * Constructor
	 */
    public GetFulfillmentOpts() {
        this.requestPath = MWGApplicationConstants.Requests.Checkout.prefix + MWGApplicationConstants.Requests.Checkout.userFulfillOpts;
    }
    
	@GET
    @Consumes(MWGApplicationConstants.Headers.generic)
    @Produces(MWGApplicationConstants.Headers.generic)
    @Path(MWGApplicationConstants.Requests.Checkout.userFulfillOpts)
    public Response getResponse(
		...
		try {		
			this.requestHeader = new MWGHeader(MWGApplicationConstants.Headers.Checkout.fulfillments, MWGApplicationConstants.Headers.json, sessionToken);
