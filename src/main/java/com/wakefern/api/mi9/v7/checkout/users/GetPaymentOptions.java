...
public class GetPaymentOptions extends BaseService {
	...
	private final static Logger logger = LogManager.getLogger(GetPaymentOptions.class);
    ...
    public Response getResponse(
		...
		try {	
            ...
            String jsonResponse = this.mwgRequest(BaseService.ReqType.GET, null, "com.wakefern.checkout.users.GetPaymentOptions");
        	...
        	LogUtil.addErrorMaps(e, MwgErrorType.USERS_GET_PAYMENT_OPTIONS);
