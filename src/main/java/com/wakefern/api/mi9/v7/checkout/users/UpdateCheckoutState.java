...
public class UpdateCheckoutState extends BaseService {
	...
	private final static Logger logger = LogManager.getLogger(UpdateCheckoutState.class);
    ...
    public Response getResponse(
		...
		try {		
            ...
            String jsonResponse = this.mwgRequest(BaseService.ReqType.PUT, null, MI9TimeoutRegistry.CHECKOUT_UPDATE_STATE, MI9TimeoutRegistry.getTimeout(MI9TimeoutRegistry.CHECKOUT_UPDATE_STATE));
