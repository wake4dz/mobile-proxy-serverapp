...
public class UpdateTimeslot extends BaseService {
	...
	private final static Logger logger = LogManager.getLogger(UpdateTimeslot.class);
    ...
    public Response getResponse(
        ...
        try {	
            ...
            String jsonResponse = this.mwgRequest(BaseService.ReqType.PUT, jsonData, "com.wakefern.checkout.users.UpdateTimeslot");
        	...
        	LogUtil.addErrorMaps(e, MwgErrorType.USERS_UPDATE_TIME_SLOT);
