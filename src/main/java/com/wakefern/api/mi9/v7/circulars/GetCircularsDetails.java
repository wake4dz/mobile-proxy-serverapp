...
public class GetCircularsDetails extends BaseService {
	...
	private final static Logger logger = LogManager.getLogger(GetCircularsDetails.class);
    ...
    public Response getResponse(
        ...
        try {	
            ...
            String jsonResponse = this.mwgRequest(BaseService.ReqType.GET, null, MI9TimeoutRegistry.CIRCULARS_GET_DETAILS, MI9TimeoutRegistry.getTimeout(MI9TimeoutRegistry.CIRCULARS_GET_DETAILS));
