...
public class GetById extends BaseService {
	...
	private final static Logger logger = LogManager.getLogger(GetById.class);
	...
	public Response getResponse(@PathParam(MWGApplicationConstants.Requests.Params.Path.productID) String productID,
		...
		try {
			...
			String jsonResponse = this.mwgRequest(BaseService.ReqType.GET, null, MI9TimeoutRegistry.PRODUCTS_GET_BY_ID, MI9TimeoutRegistry.getTimeout(MI9TimeoutRegistry.PRODUCTS_GET_BY_ID));
