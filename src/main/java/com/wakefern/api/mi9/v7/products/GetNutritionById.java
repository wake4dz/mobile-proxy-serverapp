...
public class GetNutritionById extends BaseService {
	...
	private final static Logger logger = LogManager.getLogger(GetNutritionById.class);
    ...
    public Response getResponse(
        ...
        try {	
            ...
            String jsonResponse = this.mwgRequest(BaseService.ReqType.GET, null, MI9TimeoutRegistry.PRODUCTS_GET_NUTRITION_BY_ID, MI9TimeoutRegistry.getTimeout(MI9TimeoutRegistry.PRODUCTS_GET_NUTRITION_BY_ID));
