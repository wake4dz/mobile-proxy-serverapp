...
public class GetProductBySkus extends BaseService {
	...
	private String makeRequest(String mwgStoreID, List<String> productSKUs, String sessionToken,
		...
		return this.mwgRequest(BaseService.ReqType.GET, null, MI9TimeoutRegistry.PRODUCTS_GET_BY_SKUS,
				MI9TimeoutRegistry.getTimeout(MI9TimeoutRegistry.PRODUCTS_GET_BY_SKUS));
	}
