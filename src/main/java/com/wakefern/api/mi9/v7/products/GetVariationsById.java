...
public class GetVariationsById extends BaseService {
	...
	private final static Logger logger = LogManager.getLogger(GetVariationsById.class);
    ...
    public Response getResponse(
		...
		try {
            ...
            String jsonResponse = this.mwgRequest(BaseService.ReqType.GET, null, "com.wakefern.products.GetVariationsById");
            
			if(LogUtil.isUserTrackOn) {
				if ((userID != null) && LogUtil.trackedUserIdsMap.containsKey(userID.trim())) {
		        	String trackData = LogUtil.getRequestData("storeId", storeID, "productID", productID,
