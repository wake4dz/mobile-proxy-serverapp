...
public class GetCirProductCategoriesWklySpecials extends BaseService {
    ...
    public Response getResponse(
		...
		try {
            ...
            String jsonResponse = this.mwgRequest(BaseService.ReqType.GET, null, MI9TimeoutRegistry.CIRCULAR_GET_PRODUCT_CATEGORY_WKLY_SPECIALS, MI9TimeoutRegistry.getTimeout(MI9TimeoutRegistry.CIRCULAR_GET_PRODUCT_CATEGORY_WKLY_SPECIALS));
