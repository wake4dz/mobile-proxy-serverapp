...
public class GetIngredients extends BaseService {
    ...
    public GetIngredients() {
        this.requestPath = MWGApplicationConstants.Requests.Recipes.prefix + MWGApplicationConstants.Requests.Recipes.ingredients;
    }
    ...
    public Response getResponse(
        ...
        try {	
			this.requestHeader = new MWGHeader(MWGApplicationConstants.Headers.Recipes.ingredients, MWGApplicationConstants.Headers.json, sessionToken);
        	...
        	LogUtil.addErrorMaps(e, MwgErrorType.RECIPES_GET_INGREDIENTS);
