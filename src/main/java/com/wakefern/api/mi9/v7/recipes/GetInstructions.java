...
public class GetInstructions extends BaseService {
	
	private final static Logger logger = LogManager.getLogger(CreateEmailRequest.class);
    ...
    public GetInstructions() {
        this.requestPath = MWGApplicationConstants.Requests.Recipes.prefix + MWGApplicationConstants.Requests.Recipes.instructions;
    }
    ...
    public Response getResponse(
        ...
        try {	
			this.requestHeader = new MWGHeader(MWGApplicationConstants.Headers.Recipes.instructions, MWGApplicationConstants.Headers.json, sessionToken);
            ...
            String jsonResponse = this.mwgRequest(BaseService.ReqType.GET, null, "com.wakefern.recipes.GetInstructions");
            return this.createValidResponse(jsonResponse);
        
        } catch (Exception e) {
        	LogUtil.addErrorMaps(e, MwgErrorType.RECIPES_GET_INSTRUCTIONS);
