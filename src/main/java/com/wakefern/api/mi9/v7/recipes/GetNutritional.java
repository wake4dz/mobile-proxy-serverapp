...
public class GetNutritional extends BaseService {
    ...
    public Response getResponse(
        ...
        try {		
            ...
            String jsonResponse = this.mwgRequest(BaseService.ReqType.GET, null, "com.wakefern.recipes.GetNutritional");
            return this.createValidResponse(jsonResponse);
        
        } catch (Exception e) {
        	LogUtil.addErrorMaps(e, MwgErrorType.RECIPES_GET_NUTRITIONAL);
