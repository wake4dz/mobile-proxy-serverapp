...
public class DeleteListItem extends BaseService {
	...
	private final static Logger logger = LogManager.getLogger(DeleteListItem.class);
    ...
    public Response getResponse(
        ...
        try {
            String jsonResponse = this.mwgRequest(BaseService.ReqType.DELETE, null, "com.wakefern.shoppingLists.DeleteListItem");
        	...
        	LogUtil.addErrorMaps(e, MwgErrorType.SHOPPING_LISTS_DELETE_LIST_ITEM);
