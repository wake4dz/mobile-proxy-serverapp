...
public class DeleteListItems extends BaseService {
	...
	private final static Logger logger = LogManager.getLogger(DeleteListItems.class);
    ...
    public Response getResponse(
        ...
        try {
            String jsonResponse = this.mwgRequest(BaseService.ReqType.DELETE, null, "com.wakefern.shoppingLists.DeleteListItems");
