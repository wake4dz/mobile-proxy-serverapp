...
public class GetLists extends BaseService {
	...
	private final static Logger logger = LogManager.getLogger(GetLists.class);
    ...
    public Response getResponse(
        ...
        try {
            String jsonResponse = this.mwgRequest(BaseService.ReqType.GET, null, MI9TimeoutRegistry.SHOPPINGLIST_GET_LISTS, MI9TimeoutRegistry.getTimeout(MI9TimeoutRegistry.SHOPPINGLIST_GET_LISTS));
