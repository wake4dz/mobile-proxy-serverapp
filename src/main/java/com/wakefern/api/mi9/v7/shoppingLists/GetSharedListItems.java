...
public class GetSharedListItems extends BaseService {
	...
	public Response getResponse(
		...
		try {
			String jsonResponse = mwgRequest(ReqType.GET, null,
					MI9TimeoutRegistry.SHOPPINGLIST_GET_SHARED_LIST_ITEMS,
					MI9TimeoutRegistry.getTimeout(MI9TimeoutRegistry.SHOPPINGLIST_GET_SHARED_LIST_ITEMS));
	...
	public String getListItems(HashMap<String, String> queryParam, String chainID, String userID, String listID, String accept, String sessionToken) throws Exception{
		...
		return this.mwgRequest(BaseService.ReqType.GET, null, MI9TimeoutRegistry.SHOPPINGLIST_GET_LIST_ITEMS, MI9TimeoutRegistry.getTimeout(MI9TimeoutRegistry.SHOPPINGLIST_GET_LIST_ITEMS));
	}
