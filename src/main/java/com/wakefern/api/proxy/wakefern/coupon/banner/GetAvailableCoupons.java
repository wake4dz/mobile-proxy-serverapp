...
@Path(ApplicationConstants.Requests.Proxy + CouponUtils.Requests.BannerRoutes.AvailableCoupons)
public class GetAvailableCoupons extends BaseService {
			...
			@QueryParam(CouponUtils.Requests.Params.storeId) String storeId)
	{
		...
		final String url = CouponUtils.constructCouponBannerUrl(WakefernApplicationConstants.CouponsV3.PathInfo.AvailableCoupons, banner, null, queryParams);
