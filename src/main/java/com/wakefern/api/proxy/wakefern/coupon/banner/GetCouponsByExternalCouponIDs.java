 ...
 */
@Path(ApplicationConstants.Requests.Proxy + CouponUtils.Requests.BannerRoutes.GetCouponByExternalCouponIds)
public class GetCouponsByExternalCouponIDs extends BaseService {
			...
			throws Exception
	{
		...
		this.requestPath = CouponUtils.constructCouponBannerUrl(WakefernApplicationConstants.CouponsV3.PathInfo.GetCouponByCouponId, banner, params, null);
