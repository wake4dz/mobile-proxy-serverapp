...
@Path(ApplicationConstants.Requests.Proxy + CouponUtils.Requests.BannerRoutes.ExpiredCoupons)
public class GetExpiredCoupons extends BaseService {
	...
	{
		this.requestPath = CouponUtils.constructCouponBannerUrl(WakefernApplicationConstants.CouponsV3.PathInfo.ExpiredCoupons, banner);
