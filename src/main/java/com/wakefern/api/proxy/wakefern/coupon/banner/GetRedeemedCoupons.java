...
@Path(ApplicationConstants.Requests.Proxy + CouponUtils.Requests.BannerRoutes.RedeemedCoupons)
public class GetRedeemedCoupons extends BaseService {
	...
	{
		this.requestPath = CouponUtils.constructCouponBannerUrl(WakefernApplicationConstants.CouponsV3.PathInfo.RedeemedCoupons, banner);
