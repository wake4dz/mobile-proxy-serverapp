 ...
 */
@Path(ApplicationConstants.Requests.Proxy + CouponUtils.Requests.BannerRoutes.GetSocialOffersByQuery)
public class GetSocialOffersByQuery extends BaseService {
			...
			throws Exception
	{
		...
		final String url = CouponUtils.constructCouponBannerUrl(WakefernApplicationConstants.CouponsV3.PathInfo.GetCouponListByQuery, banner, params, null);
