 ...
 */
@Path(ApplicationConstants.Requests.Proxy + CouponUtils.Requests.BannerRoutes.GetUPCsByCouponId)
public class GetUPCListByCouponID extends BaseService {
			...
			throws Exception
	{
		...
		final String url = CouponUtils.constructCouponBannerUrl(WakefernApplicationConstants.CouponsV3.PathInfo.GetUPCListByCouponId, banner, params, null);
