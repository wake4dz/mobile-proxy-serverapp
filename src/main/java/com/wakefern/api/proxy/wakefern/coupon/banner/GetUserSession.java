...
@Path(ApplicationConstants.Requests.Proxy + CouponUtils.Requests.BannerRoutes.UserLogin)
public class GetUserSession extends BaseService {
	...
	{
		final String url = CouponUtils.constructCouponBannerUrl(WakefernApplicationConstants.CouponsV3.PathInfo.UserLogin, banner);
