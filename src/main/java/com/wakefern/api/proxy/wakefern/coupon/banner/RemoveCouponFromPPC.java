 ...
 */
@Path(ApplicationConstants.Requests.Proxy + CouponUtils.Requests.BannerRoutes.RemoveCouponFromPPC)
public class RemoveCouponFromPPC extends BaseService {
	...
	public Response getInfoResponse(
			...
			throws Exception
	{
		final String url = CouponUtils.constructCouponBannerUrl(WakefernApplicationConstants.CouponsV3.PathInfo.RemoveCouponFromPPC, banner);
