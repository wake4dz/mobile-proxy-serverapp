...
@Path(ApplicationConstants.Requests.Proxy + CouponUtils.Requests.Routes.ClippedCoupons)
public class GetClippedCoupons extends BaseService {
	...
	{
		this.requestPath = CouponUtils.constructCouponV3Url(WakefernApplicationConstants.CouponsV3.PathInfo.ClippedCoupons);
