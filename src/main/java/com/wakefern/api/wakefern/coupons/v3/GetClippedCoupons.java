...
@Path(ApplicationConstants.Requests.CouponsV3.ClippedCoupons)
public class GetClippedCoupons extends BaseService {
	private final static Logger logger = Logger.getLogger(GetClippedCoupons.class);
			...
			@HeaderParam(ApplicationConstants.Requests.Header.contentType) String contentType)
	{
		...
		try {
			...
			LogUtil.addErrorMaps(e, MwgErrorType.COUPONS_V3_GET_CLIPPED_COUPONS);
