 ...
 */
@Path(ApplicationConstants.Requests.CouponsV3.GetCouponByPromoCode)
public class GetCouponByPromoCode extends BaseService {

	private final static Logger logger = Logger.getLogger(GetCouponByPromoCode.class);
			...
			@PathParam("promoCode") String promoCode)
	{
		try {
			...
			LogUtil.addErrorMaps(e, MwgErrorType.COUPONS_V3_GET_COUPON_FROM_PROMOCODE);
