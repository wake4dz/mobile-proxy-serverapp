 ...
 */
@Path(ApplicationConstants.Requests.CouponsV3.CouponList)
public class GetCouponList extends BaseService {
	private final static Logger logger = Logger.getLogger(GetCouponList.class);
			...
			@HeaderParam(ApplicationConstants.Requests.Header.contentType) String contentType)
	{
		...
		try {
			...
			LogUtil.addErrorMaps(e, MwgErrorType.COUPONS_V3_GET_COUPON_LIST);
