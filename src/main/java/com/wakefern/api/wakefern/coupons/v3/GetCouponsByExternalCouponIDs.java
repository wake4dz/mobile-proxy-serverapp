 ...
 */
@Path(ApplicationConstants.Requests.CouponsV3.GetCouponByExternalCouponIds)
public class GetCouponsByExternalCouponIDs extends BaseService {

	private final static Logger logger = Logger.getLogger(GetCouponsByExternalCouponIDs.class);
			...
			throws Exception
	{
		...
		try {
			...
			LogUtil.addErrorMaps(e, MwgErrorType.COUPONS_V3_GET_COUPONS_BY_EXTERNAL_COUPON_IDS);
