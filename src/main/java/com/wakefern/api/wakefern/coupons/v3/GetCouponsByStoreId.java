 ...
 */
@Path(ApplicationConstants.Requests.CouponsV3.GetCouponsByStoreId)
public class GetCouponsByStoreId extends BaseService {

	private final static Logger logger = Logger.getLogger(GetCouponsByStoreId.class);
			...
			throws Exception
	{
		...
		try {
			...
			LogUtil.addErrorMaps(e, MwgErrorType.COUPONS_V3_GET_COUPONS_BY_STORE_ID);
