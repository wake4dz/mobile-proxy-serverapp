...
@Path(ApplicationConstants.Requests.CouponsV3.ExpiredCoupons)
public class GetExpiredCoupons extends BaseService {
	private final static Logger logger = Logger.getLogger(GetExpiredCoupons.class);
			...
			@HeaderParam(ApplicationConstants.Requests.Header.contentType) String contentType)
	{
		...
		try {
			...
			LogUtil.addErrorMaps(e, MwgErrorType.COUPONS_V3_GET_EXPIRED_COUPONS);
