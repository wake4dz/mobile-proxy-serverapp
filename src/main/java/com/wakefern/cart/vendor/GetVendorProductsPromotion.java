...
public class GetVendorProductsPromotion extends BaseService {
    ...
    public Response getResponse(
		...
		try {
            ...
            String jsonResponse = this.mwgRequest(BaseService.ReqType.GET, null, MI9TimeoutService.CART_GET_VENDOR_PRODUCTS_PROMO, MI9TimeoutService.getTimeout(MI9TimeoutService.CART_GET_VENDOR_PRODUCTS_PROMO));
