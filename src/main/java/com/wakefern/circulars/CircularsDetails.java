...
public class CircularsDetails extends BaseService {
	...
	@GET
    @Consumes(MWGApplicationConstants.Headers.Circulars.details)
    ...
    public Response getResponse(
		...
		this.requestHeader = new MWGHeader(MWGApplicationConstants.Headers.Circulars.details, ApplicationConstants.jsonHeaderType, sessionToken);
