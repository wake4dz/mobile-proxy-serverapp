...
public class PageDetails extends BaseService {
	 ...
	 */
    public PageDetails() {
        this.requestPath = MWGApplicationConstants.Requests.Circulars.circularsPath + MWGApplicationConstants.Requests.Circulars.page;
    }
    
	@GET
    @Consumes(MWGApplicationConstants.Headers.Circulars.page)
    @Produces("application/*")
    @Path(MWGApplicationConstants.Requests.Circulars.page)
