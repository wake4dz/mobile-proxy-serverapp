...
@JsonFilter("filterByCircularItemValue")
...
public class Item {
    ...
    private List<ImageLink_> imageLinks = null;
    @JsonProperty("Links")
    ...
    @JsonProperty("ImageLinks")
    public List<ImageLink_> getImageLinks() {
        return imageLinks;
    }

    @JsonProperty("ImageLinks")
    public void setImageLinks(List<ImageLink_> imageLinks) {
