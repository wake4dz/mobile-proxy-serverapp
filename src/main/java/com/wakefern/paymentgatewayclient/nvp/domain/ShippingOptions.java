...
public final class ShippingOptions implements RequestFields {
	...
	private static final long serialVersionUID = 5770093061105544823L;
     ...
     * of this flat rate shipping option is true, Payment Gateway selects it by default 
     ...
     * option labels can be localized based on the buyer's locale, which  
     * Payment Gateway sends to your website as a parameter value in the 
     * callback request.
     *  
     ...
     * the flat rate shipping option. Limitations: Must not exceed $9,999.99 USD
