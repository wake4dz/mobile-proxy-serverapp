...
public class Search extends BaseService {
	 ...
	 */
    public Search() {
        this.requestPath = MWGApplicationConstants.Requests.Products.productPath + MWGApplicationConstants.Requests.Products.prodSearch;
    }
    ...
    public Response getResponse(
    		...
    		@DefaultValue("9999") @QueryParam(MWGApplicationConstants.queryTake) String takeCount,  // MWG Docs claim this is optional, but will return an HTTP 400 if it's missing. 
