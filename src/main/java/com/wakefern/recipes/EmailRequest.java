...
public class EmailRequest extends BaseService {
	 ...
	 */
    public EmailRequest() {
        this.requestPath = MWGApplicationConstants.Requests.Recipes.recipesPath + MWGApplicationConstants.Requests.Recipes.emailRequest;
    }
