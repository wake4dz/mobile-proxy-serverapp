...
public class Nutritional extends BaseService {
	 ...
	 */
    public Nutritional() {
        this.requestPath = MWGApplicationConstants.Requests.Recipes.recipesPath + MWGApplicationConstants.Requests.Recipes.nutritional;
    }
    ...
    public Response getResponse(
		...
		this.requestHeader = new MWGHeader(MWGApplicationConstants.Headers.Recipes.nutritional, ApplicationConstants.jsonResponseType, sessionToken);
