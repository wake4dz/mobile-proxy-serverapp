...
public class Times extends BaseService {
    ...
    public Response getResponse(
		...
		this.requestHeader = new MWGHeader(MWGApplicationConstants.Headers.Recipes.prepTimes, ApplicationConstants.jsonResponseType, sessionToken);
