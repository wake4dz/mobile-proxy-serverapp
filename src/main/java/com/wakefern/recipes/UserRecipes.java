...
public class UserRecipes extends BaseService {
	 ...
	 */
    public UserRecipes() {
        this.requestPath = MWGApplicationConstants.Requests.Recipes.recipesPath + MWGApplicationConstants.Requests.Recipes.userRecipes;
    }
