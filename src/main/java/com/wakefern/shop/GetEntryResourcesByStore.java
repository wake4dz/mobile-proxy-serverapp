...
public class GetEntryResourcesByStore extends BaseService {
    ...
    public GetEntryResourcesByStore() {
        this.requestPath = MWGApplicationConstants.Requests.Shop.prefix + MWGApplicationConstants.Requests.Shop.entryByStore;
    }
    ...
    public Response getResponse(
        ...
        try {
			this.requestHeader = new MWGHeader(MWGApplicationConstants.Headers.Shop.entry, MWGApplicationConstants.Headers.json, sessionToken);
			this.requestParams = new HashMap<String, String>();
		
			this.requestParams.put(MWGApplicationConstants.Requests.Params.Path.userID, userID);
			this.requestParams.put(MWGApplicationConstants.Requests.Params.Path.storeID, storeID);
		
            String jsonResponse = this.mwgRequest(BaseService.ReqType.GET, null, "com.wakefern.shop.GetEntryResourcesByStore");
