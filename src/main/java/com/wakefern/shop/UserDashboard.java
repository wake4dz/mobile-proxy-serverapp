...
public class UserDashboard extends BaseService {
    ...
    public Response getResponse(
		...
		this.requestHeader = new MWGHeader(MWGApplicationConstants.Headers.Shop.dashboard, ApplicationConstants.jsonResponseType, sessionToken);
