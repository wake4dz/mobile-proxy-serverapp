...
public class WakefernApplicationConstants {
	...
	public static class VCAPKeys{
		...
		public static final String sr_mwg_stage_token = "sr_mwg_stage_token";
		public static final String sr_mwg_prod_token = "sr_mwg_prod_token";
		public static final String tfg_mwg_prod_token = "tfg_mwg_prod_token";
