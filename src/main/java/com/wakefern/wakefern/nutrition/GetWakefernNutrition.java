package com.wakefern.wakefern.nutrition;
 ...
 * @since 2020-03-10
 */
@Path(WakefernApplicationConstants.APIM.apimWakefernProduct)
    ...
    public Response getResponse(@PathParam("skuStoreId") String skuStoreId) {
        ...
        try {
            ...
            wkfn.put(WakefernApplicationConstants.APIM.sub_key_header,
                    MWGApplicationConstants.getSystemProperytyValue(WakefernApplicationConstants.VCAPKeys.APIM_NUTRITION_KEY));
